...
#define MAX_TIME_NEEDED (1)
#define DOWN (0)
#define UP (1)
#define PRIORITY (1)
#define REQ_FROM_QUEUE (2)
#define NUMBER_SAMPLES_NEEDED (960)
#define MIN_THRESHOLD_SET (5)
#define CHECKER_SAMPLES (100)
#define HIGH (1)
#define LOW (1)
#define INITALIZE (0)
#define WAITING (1)
#define SAMPLING (2)
#define SAMPLE_OFFSET (100)
