...
unsigned int BP_INDEX_WIDTH = 16;
...
bool TRACE_CACHE_ENABLE = true;
uint64_t TRACE_CACHE_PROP_M = 3;
uint64_t TRACE_CACHE_PROP_N = 16;
uint64_t TRACE_CACHE_CAPACITY = 512;
uint64_t TRACE_CACHE_ASSOC = 4;
uint64_t TRACE_CACHE_TERM_HEURISTIC = 0;
uint64_t TRACE_CACHE_MAX_ONGOING_FILL = 1;
bool TRACE_CACHE_NON_BLOCK_FILL = true;

bool TRACE_INDEX_WITH_PRED_BIT = true;

uint32_t MULTI_PRED_NUM_PRED = TRACE_CACHE_PROP_M;