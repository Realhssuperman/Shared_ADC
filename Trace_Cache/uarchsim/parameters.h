...
extern unsigned int BP_INDEX_WIDTH;
...
extern bool TRACE_CACHE_ENABLE;
extern uint64_t TRACE_CACHE_PROP_M;
extern uint64_t TRACE_CACHE_PROP_N;
extern uint64_t TRACE_CACHE_CAPACITY;
extern uint64_t TRACE_CACHE_ASSOC;
extern uint64_t TRACE_CACHE_TERM_HEURISTIC;
extern uint64_t TRACE_CACHE_MAX_ONGOING_FILL;
extern bool TRACE_CACHE_NON_BLOCK_FILL;
extern bool TRACE_INDEX_WITH_PRED_BIT;

extern uint32_t MULTI_PRED_NUM_PRED;
