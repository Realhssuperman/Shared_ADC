...
//extern int32_t ACTIVE_LIST_SIZE;
...
class renamer {
 private:
  ...
  /////////////////////////////////////////////////////////////////////
  std::unique_ptr<rmt_entry_t[]> mRMT = nullptr;

  /////////////////////////////////////////////////////////////////////
  // Structure 2: Architectural Map Table
  // Entry contains: physical register mapping
  /////////////////////////////////////////////////////////////////////
  std::unique_ptr<phy_reg_idx_t[]> mAMT = nullptr;
  ...
  /////////////////////////////////////////////////////////////////////
  CircularQueue<phy_reg_idx_t> mFreeList;
  ...
  //   depending on your implementation.
  /////////////////////////////////////////////////////////////////////
  CircularQueue<active_list_entry_t> mActiveList;
  ...
  // 3. checkpointed GBM
  /////////////////////////////////////////////////////////////////////
  std::unique_ptr<shadow_map_entry_t[]> mShadowMapArray;
  ...
  uint64_t m_n_phy_regs;
  uint8_t m_n_branches;
  uint64_t m_n_al_size;
  uint64_t m_n_fl_size;
